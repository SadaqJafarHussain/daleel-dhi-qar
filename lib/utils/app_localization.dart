...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'request_verification_hint': 'Get your official verification badge',
      'verification_pending': 'Verification Request Pending',
      'verification_pending_hint': 'You will be notified when approved',
      'verification_request_sent': 'Verification request sent successfully',
      'account_verified': 'Verified Account',
      'account_verified_hint': 'Your account has been officially verified',
      ...
      'phone': 'Phone',
      'website': 'Website',
      'no_contact_info': 'No contact information available yet.',
...
For privacy concerns, contact us through the app settings.''',
      ...
      "service_submitted_for_review": "Service submitted for review",
      "service_pending_review_desc": "Your service is under review and will appear once approved.",
      ...
      "my_services_empty": "You haven't added any services yet.",
      ...
      // Location Picker
      'tap_map_to_pin': 'Tap anywhere on the map to pin your location',
      ...
      'forgot_password_desc': 'Enter your phone number to receive a password reset link',
    ...
    'ar': {
      ...
      'request_verification_hint': 'احصل على شارة التوثيق الرسمية',
      'verification_pending': 'طلب التوثيق قيد المراجعة',
      'verification_pending_hint': 'سيتم إشعارك عند الموافقة',
      'verification_request_sent': 'تم إرسال طلب التوثيق بنجاح',
      'account_verified': 'حساب موثَّق',
      'account_verified_hint': 'تم توثيق حسابك رسمياً',
      ...
      'no_contact_info': 'لا توجد معلومات تواصل متاحة حالياً.',
      'update_required': 'تحديث مطلوب',
      'update_message': 'يتوفر إصدار جديد من التطبيق. يرجى التحديث للاستمرار في الاستخدام.',
...
لأي مخاوف تتعلق بالخصوصية، تواصل معنا عبر إعدادات التطبيق.''',
      ...
      "service_submitted_for_review": "تم إرسال الخدمة للمراجعة",
      "service_pending_review_desc": "خدمتك قيد المراجعة وستظهر للعملاء بعد الموافقة عليها.",
      ...
      "my_services_empty": "لم تضف أي خدمات بعد.",
      ...
      // Location Picker
      'tap_map_to_pin': 'انقر في أي مكان على الخريطة لتحديد موقعك',
      'confirm_location': 'تأكيد الموقع',
      'selected_location': 'الموقع المحدد',
      'fetching_address': 'جارٍ تحديد العنوان...',
      ...
      'forgot_password_desc': 'أدخل رقم هاتفك لاستلام رابط إعادة تعيين كلمة المرور',
      'send_reset_link': 'إرسال رابط الاستعادة',
      'reset_link_sent': 'تم إرسال رابط إعادة التعيين. تحقق من بريدك الإلكتروني.',
      'reset_link_failed': 'فشل إرسال الرابط. حاول مرة أخرى.',
      'name': 'الاسم',
      ...
      'report_service': 'الإبلاغ عن الخدمة',
      'report_select_reason': 'اختر سبب الإبلاغ',
      'report_sent': 'تم إرسال البلاغ. شكراً لك!',
