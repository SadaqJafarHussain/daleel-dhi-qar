...
const Map<String, String> enTranslations = {
  ...
  'featured_services_subtitle': 'Hand-picked by our team',
  'no_featured_services': 'No featured services',
  'no_featured_services_subtitle': 'No services have been featured yet',
  'hotels': 'Hotels',
  ...
  'delete_account_confirm': 'Are you sure you want to delete your account? All your data will be permanently deleted and this action cannot be undone.',
  'delete_account_success': 'Your account has been successfully deleted',
  'delete_account_error': 'An error occurred while deleting the account, please try again later',
  'delete': 'Delete',
  ...
  'forgot_password_desc': 'Enter your phone number and our support team will reset your password.',
  'reset_request_desc': 'Enter your phone number and our support team will reset your password within 24 hours.',
  'reset_request_submit': 'Submit Request',
  'reset_request_success_title': 'Request Submitted!',
  'reset_request_success_desc': 'Your request has been received. Our support team will contact you shortly and reset your password.',
  'reset_request_contact': 'Or contact support directly:',
  'reset_request_whatsapp': 'Chat on WhatsApp',
  'reset_request_phone_not_found': 'No account found with this phone number. Please check the number and try again.',
  'reset_request_already_pending': 'You already have a pending reset request. Our team will contact you soon — no need to submit again.',
  'reset_request_failed': 'Failed to submit request. Please check your connection and try again.',
  'password_reset_done_by_support': 'Your password has been reset by support. Please login with your new temporary password and change it immediately.',
  'password_reset_rejected_by_support': 'Your password reset request was not approved. Please contact support for assistance.',
  'name': 'Name',
  ...
  'select_interests_min3': 'Select at least 3 interests to continue',
  ...
  'newest': 'Newest',
  'nearest': 'Nearest',
  'no_services_in_status': 'No services in this category',
};
