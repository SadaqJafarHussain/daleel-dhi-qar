...
const Map<String, String> arTranslations = {
  ...
  'featured_services_subtitle': 'اختيارات خاصة من الإدارة',
  'no_featured_services': 'لا توجد خدمات مميزة',
  'no_featured_services_subtitle': 'لم يتم تمييز أي خدمات بعد',
  'hotels': 'فنادق',
  'restaurants': 'مطاعم',
  'airports': 'مطارات',
  'pharmacies': 'صيدليات',
  ...
  'delete_account_confirm': 'هل أنت متأكد من حذف حسابك؟ سيتم حذف جميع بياناتك نهائياً ولا يمكن التراجع عن هذا الإجراء.',
  'delete_account_success': 'تم حذف حسابك بنجاح',
  'delete_account_error': 'حدث خطأ أثناء حذف الحساب، يُرجى المحاولة لاحقاً',
  'delete': 'حذف',
  ...
  'forgot_password_desc': 'أدخل رقم هاتفك وسيقوم فريق الدعم بإعادة تعيين كلمة المرور.',
  'reset_request_desc': 'أدخل رقم هاتفك وسيتواصل معك فريق الدعم لإعادة تعيين كلمة المرور خلال 24 ساعة.',
  'reset_request_submit': 'إرسال الطلب',
  'reset_request_success_title': 'تم إرسال الطلب!',
  'reset_request_success_desc': 'تم استلام طلبك بنجاح. سيتواصل معك فريق الدعم قريباً لإعادة تعيين كلمة المرور.',
  'reset_request_contact': 'أو تواصل مع الدعم مباشرةً:',
  'reset_request_whatsapp': 'تواصل عبر واتساب',
  'reset_request_phone_not_found': 'لا يوجد حساب مرتبط بهذا الرقم. تحقق من الرقم وحاول مجدداً.',
  'reset_request_already_pending': 'لديك طلب قيد المراجعة بالفعل. سيتواصل معك فريقنا قريباً — لا داعي لإعادة الإرسال.',
  'reset_request_failed': 'فشل إرسال الطلب. تحقق من اتصالك بالإنترنت وحاول مجدداً.',
  'password_reset_done_by_support': 'تم إعادة تعيين كلمة مرورك من قِبل فريق الدعم. سجّل الدخول بكلمة المرور الجديدة المؤقتة وغيّرها فوراً.',
  'password_reset_rejected_by_support': 'لم يتم قبول طلب إعادة تعيين كلمة المرور. تواصل مع الدعم للمساعدة.',
  'name': 'الاسم',
  ...
  'select_interests_min3': 'اختر 3 اهتمامات على الأقل للمتابعة',
  ...
  'newest': 'الأحدث',
  'nearest': 'الأقرب',
  'no_services_in_status': 'لا توجد خدمات في هذه الفئة',
};
